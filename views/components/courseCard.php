<div class="flex flex-col w-5/6 sm:w-1/3 h-full max-h-[367px] bg-primary m-5 sm:m-2 p-5 justify-center items-center rounded-2xl">
    ...
    <button class="w-1/2 text-center bg-color rounded p-1 hover:opacity-80 font-bold">
        ADD TO CART
    </button>
</div>