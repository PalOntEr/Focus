<div class="flex flex-col w-5/6 md:w-1/3 max-h-96 bg-primary m-5 md:m-2 p-5 justify-center items-center rounded-2xl shadow-lg hover:scale-150">
    ...
    <div class="flex justify-between w-full font-semibold">
        <div class="text-comp-2"><a href="/profile">Instructor</a></div>
