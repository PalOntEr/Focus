<div id="LEVEL_NUM" class="flex flex-col w-full sm:w-48 h-fit sm:h-48 max-h-[367px] bg-primary mb-2 sm:m-2 p-2 justify-center items-center rounded-2xl" style="width=500px;">
    <div class="flex justify-center w-1/2 h-2/3 mb-1 bg-color rounded-2xl">
