...
<div class="container sm:mx-auto flex flex-col items-center self-center sm:items-start sm:flex-row w-full h-5/6 sm:h-1/3 xl:h-fit space-y-2 sm:space-y-0 sm:space-x-4">
    <div class="flex justify-center bg-secondary w-5/6 sm:w-1/4 h-2/5 sm:h-full p-2 rounded-xl">
        <?php require 'views/components/courseInfo.php'; ?>
    </div>
    <div class="flex bg-secondary w-5/6 sm:w-3/4 h-3/5 sm:h-full px-5 py-2 text-justify rounded-xl overflow-y-scroll">
...
<div class="container mx-auto flex flex-col sm:flex-row items-center justify-center w-5/6 sm:w-full h-fit my-2 sm:overflow-y-scroll flex-wrap">
    <?php
    for( $i = 1; $i <= 101; $i++ ) {
        $level = $i;
        $stars = rand( 1, 5 );
...
<div class="container mx-auto flex flex-col sm:flex-row items-center justify-center w-5/6 sm:w-full h-fit sm:overflow-y-scroll my-2 flex-wrap">
    <?php
    for( $i = 1; $i <= 100; $i++ ) {
