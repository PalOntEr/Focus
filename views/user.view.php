    ...
    <div class="flex flex-row place-content-center lg:place-content-between">
        <div class="flex">
            ...
            <div class="self-center">
                <h2 id="User-Role" class="text-4xl text-center md:text-left text-secondary font-semibold">Rol de Usuario</h2>
                <h1 id="User" class="text-8xl text-primary font-extrabold">Usuario</h1>
                <p id="User-Info" class="text-secondary">Registrado en noviembre del 2024 Edad: 24 años</p>
            </div>
        </div>
